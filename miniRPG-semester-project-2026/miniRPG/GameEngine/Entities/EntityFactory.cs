...
public static class EntityFactory
{
    ...
    public static Entity HealthBar(float posX, float posY)
    {
        var e = new Entity();
        
        e.AddComponent(new UiComponent { X = posX, Y = posY, Height = 100, Width = 100 });
        e.AddComponent(new StatisticBarComponent());
